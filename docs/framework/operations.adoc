...
* For each activity, identify qualified suppliers of the resource required to perform them and decide whether to outsource them or not
* Decide how the activities performs in-house are performed, which knowledge and skills employees possess and how effective coordination is achieved
* Adjust capacity to meet the variability of demand while achieving the targeted service levels and operating costs
* Continuously improve processes through incremental and breakthrough innovations
* Manage operational risks to improve the resiliency of operations
