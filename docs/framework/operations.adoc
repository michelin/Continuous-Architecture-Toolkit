...
The figure below inspired from the VCAP framework summarizes the dimension to consider when assessing an existing Operations and formulating an _Operation Strategy_.
