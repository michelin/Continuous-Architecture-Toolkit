...
* Global architecture asssement of their product portfolio (level of obsolecence & IT Debt, alignement with architecture principles &blueprints, quality of sevice, quality of experience,...)
