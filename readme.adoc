...
Continuous architecture toolkit was initially developed by mailto:thierry.fraudet@michelin.com[Thierry Fraudet] & mailto:ojauze@gmail.com[Olivier Jauze] from Michelin and by mailto:nch.nicolas.chevalier@gmail.com[Nicolas Chevalier] from Gluendo to setup an agile architecture operating model and to support the Michelin digital journey.
...
* mailto:romain.chapon@michelin.com[Romain Chapon] (Michelin)
* mailto:yoni.boukhobza@socgen.com[Yoni Boukhobza] (Société Générale)
