...
In the Fidelity and ING case, the new organizational model was implemented in a top-down manner... Employees had to re-apply to new positions. 

Adopting a new organizational model is not sufficient. Other aspects of the operating model must change:

* On the HR side, re-skilling and up-skilling must be planned and executed
