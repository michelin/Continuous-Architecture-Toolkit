...
Describing a comprehensive change management approach is beyond the scope of Continuous Architecture. For the reader who is looking for a comprehensive change management framework, Kotter's 8-Step Process for Leading Change footnote:[See: https://www.kotterinc.com/8-steps-process-for-leading-change/] is an industry recognized one.
