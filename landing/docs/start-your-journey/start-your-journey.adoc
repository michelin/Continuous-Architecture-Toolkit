...
A word of advise, it is risky to focus on frameworks that are in the solution space before making sure your enterprise is tackling the right problems. It applies both to _Agile @Scale_ frameworks such as SAFe or Spotify and change management frameworks.
